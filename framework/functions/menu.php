...
class wlgx_Walker_Nav_Menu extends Walker_Nav_Menu {
...
class wlgx_Walker_Simplenav_Menu extends Walker_Nav_Menu {
...
// Add Top Menu
add_action( 'init', 'register_wlgx_menu' );
function register_wlgx_menu() {
	register_nav_menus(
		array(
			'wlgx_main_menu' => __( 'Main Menu', 'wlgx' ),
			'wlgx_footer_menu' => __( 'Footer Menu', 'wlgx' ),
		)
	);
}
