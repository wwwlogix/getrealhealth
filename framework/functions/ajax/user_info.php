 ...
 */
add_action( 'wp_ajax_nopriv_wlgx_ajax_user_info', 'wlgx_ajax_user_info' );
add_action( 'wp_ajax_wlgx_ajax_user_info', 'wlgx_ajax_user_info' );
function wlgx_ajax_user_info() {
