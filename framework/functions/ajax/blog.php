 ...
 */
add_action( 'wp_ajax_nopriv_wlgx_ajax_blog', 'wlgx_ajax_blog' );
add_action( 'wp_ajax_wlgx_ajax_blog', 'wlgx_ajax_blog' );
function wlgx_ajax_blog() {
	...
	if ( isset( $template_vars['query_args'] ) AND is_array( $template_vars['query_args'] ) ) {
		...
		$allowed_post_types = array( 'wlgx_casestudy', 'post' );
	...
	wlgx_load_template( 'templates/blog/listing', $template_vars );
