...
$atts = wlgx_shortcode_atts( $atts, 'wlgx_sharing' );

// The list of available sharing providers and additional in-shortcode data
$providers = array(
	'email' => array(
		'title' => __( 'Email this', 'wlgx' ),
	),
	'facebook' => array(
		'title' => __( 'Share this', 'wlgx' ),
	),
	'twitter' => array(
		'title' => __( 'Tweet this', 'wlgx' ),
	),
	'gplus' => array(
		'title' => __( 'Share this', 'wlgx' ),
	),
...
if ( $atts['counters'] == 'show' ) {
	$counts = wlgx_get_sharing_counts( $atts['url'], array_keys( $providers ) );
}
