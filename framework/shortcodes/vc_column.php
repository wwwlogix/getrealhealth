...
} elseif ( function_exists( 'wlgx_wpb_translateColumnWidthToSpan' ) ) {
	$width = wlgx_wpb_translateColumnWidthToSpan( $atts['width'] );
}

if ( function_exists( 'vc_column_offset_class_merge' ) ) {
	$width = vc_column_offset_class_merge( $atts['offset'], $width );

} elseif ( function_exists( 'wlgx_vc_column_offset_class_merge' ) ) {
	$width = wlgx_vc_column_offset_class_merge( $atts['offset'], $width );
}
...
} elseif ( function_exists( 'wlgx_vc_shortcode_custom_css_has_property' ) AND wlgx_vc_shortcode_custom_css_has_property(
		$atts['css'], array(
		'border',
		'background',
	)
