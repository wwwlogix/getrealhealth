...
$atts = wlgx_shortcode_atts( $atts, 'wlgx_single_image' );
...
if ( ! $atts['lightbox'] AND ! empty( $atts['link'] ) ) {
	...
	$link = array_merge( $link, wlgx_vc_build_link( $atts['link'] ) );
}
...
$output .= '<div class="wlgx-frame' . $frame_classes . '">' . $image_html . '</div>';
$output .= '</div>';
