...
?>
<div id="<?php echo $cat_slug; ?>">
<?php echo $filter_html; ?>

<?php

// Preparing template settings for featured post template
$template_vars = array(
	'metas' => $metas,
	'ratio' => $ratio,
	'is_widget' => $is_widget,
...
while ( have_posts() ) {
	...
	if ( usof_meta( 'wlgx_tile_featured_category' ) == $cat_slug) {
		$found_id = get_the_ID();
		wlgx_load_template( 'templates/casestudy/featured-post', $template_vars );
	}
...
?>
	...
	<div  class="w-casestudy<?php echo $classes ?>">
