 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/form/email'
 * @action After the template: 'wlgx_after_template:templates/form/email'
 * @filter Template variables: 'wlgx_template_vars:templates/form/email'
 */
