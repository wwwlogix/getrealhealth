 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/form/info'
 * @action After the template: 'wlgx_after_template:templates/form/info'
 * @filter Template variables: 'wlgx_template_vars:templates/form/info'
 */
