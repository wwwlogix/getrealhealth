 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/form/submit'
 * @action After the template: 'wlgx_after_template:templates/form/submit'
 * @filter Template variables: 'wlgx_template_vars:templates/form/submit'
 */

$name = isset( $name ) ? $name : '';
$title = isset( $title ) ? $title : __( 'Submit', 'wlgx' );
