 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/form/password'
 * @action After the template: 'wlgx_after_template:templates/form/password'
 * @filter Template variables: 'wlgx_template_vars:templates/form/password'
 */
