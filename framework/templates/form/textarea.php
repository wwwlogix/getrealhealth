 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/form/textarea'
 * @action After the template: 'wlgx_after_template:templates/form/textarea'
 * @filter Template variables: 'wlgx_template_vars:templates/form/textarea'
 */
