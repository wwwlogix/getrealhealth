 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/form/textfield'
 * @action After the template: 'wlgx_after_template:templates/form/textfield'
 * @filter Template variables: 'wlgx_template_vars:templates/form/textfield'
 */
...
if ( ! isset( $id ) ) {
	...
	$id = 'wlgx_form_' . $wlgx_form_index . '_' . $name;
}
...
<div class="w-form-row for_<?php echo $name ?><?php echo $classes ?>">
	...
	<div class="w-form-row-field">
		<?php do_action( 'wlgx_form_field_start', $vars ) ?>
		...
		<?php do_action( 'wlgx_form_field_end', $vars ) ?>
	</div>
