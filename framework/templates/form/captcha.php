 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/form/captcha'
 * @action After the template: 'wlgx_after_template:templates/form/captcha'
 * @filter Template variables: 'wlgx_template_vars:templates/form/captcha'
 */
...
<div class="w-form-row for_<?php echo $name ?><?php echo $classes ?>">
	...
	<div class="w-form-row-field">
		<?php do_action( 'wlgx_form_captcha_start', $vars ) ?>
		...
		<?php do_action( 'wlgx_form_captcha_end', $vars ) ?>
	</div>
