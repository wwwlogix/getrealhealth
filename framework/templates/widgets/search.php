 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/widgets/search'
 * @action After the template: 'wlgx_after_template:templates/widgets/search'
 * @filter Template variables: 'wlgx_template_vars:templates/widgets/search'
 */


$context = isset( $context ) ? $context : 'simple';
$layout = wlgx_get_option( 'header_search_layout', 'fullscreen' );
...
$form_template_vars = array(
	...
	'fields' => array(
		's' => array(
			'type' => 'textfield',
			'title' => ( $layout == 'fullscreen' ) ? __( 'Just type and press \'enter\'', 'wlgx' ) : '',
			'placeholder' => __( 'search', 'wlgx' ) . ' ...',
		),
		'submit' => array(
			'type' => 'submit',
			'title' => __( 'Search', 'wlgx' ),
		),
	),
);
if ( $context != 'widget' ) {
