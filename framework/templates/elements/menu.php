...
$menu_location = apply_filters( 'wlgx_main_menu_location', 'wlgx_main_menu' );
...
wp_nav_menu(
	array(
		...
		'walker' => new wlgx_Walker_Nav_Menu,
		'items_wrap' => '%3$s',
		'fallback_cb' => FALSE,
	)
);
echo '<li class="menu-item"><a class="w-btn style_solid color_secondary icon_none" href="http://grhnew.wpengine.com/request-a-demo/" style="font-size: 14px; font-weight:bold;">
<span class="w-btn-label">REQUEST A DEMO</span>
</a></li>';
echo '</ul>';
echo '<div class="w-nav-options hidden"';
echo wlgx_pass_data_to_js(
	array(
