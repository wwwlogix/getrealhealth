 ...
 *
 * @action Before the template: 'wlgx_before_template:templates/blog/single-post-author'
 * @action After the template: 'wlgx_after_template:templates/blog/single-post-author'
 */
