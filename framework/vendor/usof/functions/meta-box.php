...
add_action( 'load-post.php', 'wlgx_post_meta_boxes_setup' );
add_action( 'load-post-new.php', 'wlgx_post_meta_boxes_setup' );

function wlgx_post_meta_boxes_setup() {

	$config = wlgx_config( 'meta-boxes', array() );

	foreach ( $config as &$meta_box ) {
		new wlgx_Meta_Box( $meta_box );
	}
}
