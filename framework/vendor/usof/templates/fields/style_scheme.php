...
if ( ! isset( $style_schemes ) ) {
	$style_schemes = wlgx_config( 'style-schemes' );
}
...
$output .= '<input type="text" id="style_scheme_name" value="" placeholder="' . __( 'Color Scheme Name', 'wlgx' ) . '"/>';
$output .= '<button id="save_style_scheme" class="usof-button"><span>' . __( 'Save Color Scheme', 'wlgx' ) . '</span>';
$output .= '<span class="usof-preloader"></span></button>';
$output .= '</div></div>';

// JSON data
$output .= '<div class="usof-form-row-control-schemes-json"' . wlgx_pass_data_to_js( $style_schemes ) . '></div>';
$output .= '<div class="usof-form-row-control-custom-schemes-json"' . wlgx_pass_data_to_js( $custom_style_schemes ) . '></div>';

$first_style_scheme = array_shift( $style_schemes );
$style_scheme_colors = array_keys( $first_style_scheme['values'] );
$output .= '<div class="usof-form-row-control-colors-json"' . wlgx_pass_data_to_js( $style_scheme_colors ) . '></div>';

$i18n = array(
	'delete_confirm' => __( 'Are you sure want to delete this Color Scheme?', 'wlgx' ),
	'create_error_alert' => __( 'Please enter Color Scheme Name', 'wlgx' ),
	'create_confirm' => __( 'Do you want save changes to the current Color Scheme?', 'wlgx' ),
);
$output .= '<div class="usof-form-row-control-i18n"' . wlgx_pass_data_to_js( $i18n ) . '></div>';
