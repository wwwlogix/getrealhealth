...
$field['label'] = isset( $field['label'] ) ? $field['label'] : __( 'Set Image', 'wlgx' );
...
$output .= '<div class="usof-button type_change"><span>' . __( 'Change', 'wlgx' ) . '</span></div>';
$output .= '<div class="usof-button type_remove"><span>' . __( 'Remove', 'wlgx' ) . '</span></div>';
$output .= '</div>';
$output .= '</div>';
$output .= '</div>';
