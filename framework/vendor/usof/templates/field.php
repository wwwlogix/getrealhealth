...
if ( $field['type'] == 'wrapper_start' ) {
	...
	if ( isset( $field['show_if'] ) AND is_array( $field['show_if'] ) AND ! empty( $field['show_if'] ) ) {
		// Showing conditions
		echo '<div class="usof-form-wrapper-showif"' . wlgx_pass_data_to_js( $field['show_if'] ) . '></div>';
	}
...
if ( isset( $field['show_if'] ) AND is_array( $field['show_if'] ) AND ! empty( $field['show_if'] ) ) {
	// Showing conditions
	echo '<div class="usof-form-row-showif"' . wlgx_pass_data_to_js( $field['show_if'] ) . '></div>';
}
