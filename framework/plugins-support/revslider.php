 ...
 *
 * @link http://codecanyon.net/item/slider-revolution-responsive-wordpress-plugin/2751380?ref=wwwlogix
 */
...
add_action( 'wp_enqueue_scripts', 'wlgx_move_revslider_js_footer' );
function wlgx_move_revslider_js_footer() {
