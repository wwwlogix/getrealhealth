	...
	array(
		...
		'params' => array(
			...
			array(
				...
				'heading' => __( 'Photo on hover (optional)', 'wlgx' ),
				'type' => 'attach_image',
			...
			array(
				...
				'value' => array(
					...
					__( 'Simple (rounded photo)', 'wlgx' ) => 'simple_circle',
					__( 'Compact', 'wlgx' ) => 'square',
					__( 'Compact (rounded photo)', 'wlgx' ) => 'circle',
					__( 'Modern', 'wlgx' ) => 'modern',
					__( 'Trendy', 'wlgx' ) => 'trendy',
				),
			...
			array(
				'param_name' => 'effect',
				'heading' => __( 'Photo Effect', 'wlgx' ),
				'type' => 'dropdown',
				'value' => array(
					__( 'None', 'wlgx' ) => 'none',
					__( 'Sepia', 'wlgx' ) => 'sepia',
					__( 'Black & White', 'wlgx' ) => 'bw',
					__( 'Faded', 'wlgx' ) => 'faded',
					__( 'Colored', 'wlgx' ) => 'colored',
				),
...
class WPBakeryShortCode_wlgx_person extends WPBakeryShortCode {
