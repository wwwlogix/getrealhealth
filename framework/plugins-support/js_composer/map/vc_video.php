...
vc_add_params(
	...
	array(
		'param_name' => 'link',
		'heading' => __( 'Video link', 'wlgx' ),
		'description' => sprintf( __( 'Check supported formats on %s', 'wlgx' ), '<a href="http://codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F" target="_blank">WordPress Codex</a>' ),
		'type' => 'textfield',
	...
	array(
		...
		'type' => 'checkbox',
		'value' => array( __( 'Show suggested videos when the video finishes', 'wlgx' ) => TRUE ),
	...
	array(
		...
		'type' => 'checkbox',
		'value' => array( __( 'Show video title and player actions', 'wlgx' ) => TRUE ),
		( ( $config['atts']['video_title'] !== FALSE ) ? 'std' : '_std' ) => $config['atts']['video_title'],
		'weight' => 52,
	),
	array(
		'param_name' => 'ratio',
		'heading' => __( 'Aspect Ratio', 'wlgx' ),
		'type' => 'dropdown',
		'value' => array(
			'21x9' => '21x9',
			'16x9' => '16x9',
	...
	array(
		...
		'heading' => __( 'Max Width in pixels', 'wlgx' ),
		'type' => 'textfield',
	...
	array(
		'param_name' => 'align',
		'heading' => __( 'Video Alignment', 'wlgx' ),
		'type' => 'dropdown',
		'value' => array(
			__( 'Left', 'wlgx' ) => 'left',
